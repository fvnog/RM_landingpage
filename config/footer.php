                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="widget footer-nav-widget mb-40 wow fadeInUp" data-wow-delay=".15s">
                            ...
                            <ul class="widget-nav">
                                ...
                                <li><a href="services.html">Flyers</a></li>
                                <li><a href="services.html">Logo</a></li>
                                <li><a href="services.html">Site</a></li>
                                <li><a href="services.html">BOT</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="widget footer-nav-widget mb-40 wow fadeInUp" data-wow-delay=".20s">
                            ...
                            <ul class="widget-nav">
                                <li><a href="services.html">WebSite</a></li>
                                <li><a href="services.html">Design Gráfico</a></li>
                                <li><a href="services.html">Gestão de Rede Social</a></li>
                                <li><a href="services.html">Automação</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="widget newsletter-widget mb-40 wow fadeInUp" data-wow-delay=".30s">
                            <div class="newsletter-content">
                                <h3>Se inscreva em nossa
                                    Newsletter</h3>
                                <p>Fique por dentro das últimas novidades! Assine nossa Newsletter para receber informações atualizadas, artigos empolgantes e conteúdo exclusivo diretamente na sua caixa de entrada.</p>
                                <form>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="copyright-text">
                            <p>&copy; 2023. All rights reserved  by ResultarMind</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
